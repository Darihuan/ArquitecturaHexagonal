...
@Getter
@Setter
public class PersonaSaveDTOOutput {
    Integer id;
    String user;
    String password;
    String surname;
    ...
    public Persona toPersona(PersonaSaveDTOOutput personaDTO){
    ...
    public PersonaSaveDTOOutput toPersonaSaveDTO(Persona persona){
        PersonaSaveDTOOutput devolver=new PersonaSaveDTOOutput();
