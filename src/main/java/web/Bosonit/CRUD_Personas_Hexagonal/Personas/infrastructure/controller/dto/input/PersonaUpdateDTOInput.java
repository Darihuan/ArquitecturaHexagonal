...
@Getter
@Setter
public class PersonaUpdateDTOInput {
    Integer id;
    String user;
    String password;
    String surname;
    ...
    public Persona toPersona(PersonaUpdateDTOInput personaDTO){
    ...
    public PersonaUpdateDTOInput toPersonaUpdateDTO(Persona persona){
        PersonaUpdateDTOInput devolver=new PersonaUpdateDTOInput();
