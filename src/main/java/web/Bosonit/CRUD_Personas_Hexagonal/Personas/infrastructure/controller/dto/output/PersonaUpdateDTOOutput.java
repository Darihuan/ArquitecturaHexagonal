...
@Getter
@Setter
public class PersonaUpdateDTOOutput {
    Integer id;
    String user;
    String password;
    String surname;
    ...
    public Persona toPersona(PersonaUpdateDTOOutput personaDTO) {
    ...
    public PersonaUpdateDTOOutput toPersonaUpdateDTO(Persona persona) {
        PersonaUpdateDTOOutput devolver = new PersonaUpdateDTOOutput();
